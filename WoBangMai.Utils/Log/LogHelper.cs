...
namespace WoBangMai.Utils
{
    ...
    public class LogHelper
    {
        ...
        /// </summary>
        /// <param name="info"></param>
        public static void WriteErrLog(Exception ex, HttpContext context)
        {
            if (logerror.IsErrorEnabled)
            {
                ...
                if (context != null)
                {
                    ErrString.AppendFormat("发生异常页:{0}", context.Request.Url.ToString());
                    ErrString.AppendLine();
                }
                ...
                ErrString.AppendLine();
                logerror.Error(ErrString.ToString());
            }
        }
