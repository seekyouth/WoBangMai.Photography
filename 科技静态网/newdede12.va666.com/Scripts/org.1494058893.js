...
(function(U, u4, A, r4) {
    ...
    U[f4R.f6X][f4R.U6n] = function(I) {
        var P = "ready", W = "pageshow", N = "appVersion", k = "S6h", j = "y6h", C = "x6h", m = "effect_speed", e = "effectspeed", F = "h6h", v = "failurelimit", Y = "Y4h", J = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAAXNSR0IArs4c6QAAAARnQU1BAACxjwv8YQUAAAAJcEhZcwAADsQAAA7EAZUrDhsAAAANSURBVBhXYzh8+PB/AAffA0nNPuCLAAAAAElFTkSuQmCC", i = "original", K4 = "failure_limit";
        function n4() {
            var u = f4R.l0c;
            R4[f4R.k5i](function() {
...
!function() {
    ...
    var K5 = [ [ f4R.e0l, f4R.Q0l, f4R.A0l, f4R.Q0c ], [ q1, f4R.B0l, f4R.T7l, f4R.Q0l ], [ m5, m1, q1, s8 ], [ X5, z8, f4R.O9l, f4R.P2l ], [ e1, a1, f4R.s9l, v6 ], [ y2, e1, E8, f4R.R9l ], [ p5, C6, S5, x1 ], [ f4R.Q7X, g1, E5, a1 ], [ r8, f4R.G1X, T1, C5 ], [ X8, A8, t8, W5 ], [ R8, f8, C1, A4 ], [ n5, n6, f4R.o2g, N4 ], [ h8, V8, x8, C1 ], [ W1, M8, k8, K8 ], [ R5, F1, F6, f4R.l0g ], [ Q8, L5, q, f4R.s3e ], [ e8, w1, h5, s6 ], [ G6, y8, U6, w4 ], [ i6, a4, p8, H6 ], [ f6, P6, C4, T6 ], [ j6, l8, T8, C8 ], [ J6, G1, e6, t1 ], [ s1, K1, o8, W8 ], [ h1, P8, J8, R6 ], [ O6, U8, Z8, B8 ], [ y6, G8, a8, t6 ], [ p6, D8, r6, K6 ], [ z6, o6, L6, N6 ], [ v4, b6, w6, k6 ], [ Y4, H4, u6, B6 ], [ b4, Z6, E6, l4 ], [ q6, c6, i4, x6 ], [ F4, v4, D6, m6 ], [ a6, J4, o4, W6 ], [ Y6, I6, g6, U4 ], [ W4, E4, X4, Q4 ], [ k4, I4, x4, d6 ], [ S6, h6, f4, O4 ], [ M4, Z4, g4, p4 ], [ e4, t4, G4, O6 ] ], d8 = function() {
        ...
        function d4(T, u) {
            var B = "data:image/gif;base64,iVBORw0KGgoAAAANSUhEUgAAAAUAAAAFCAYAAACNbyblAAAAHElEQVQI12P4//8/w38GIAXDIBKE0DHxgljNBAAO9TXL0Y4OHwAAAABJRU5ErkJggg==", E = "onabort", S = "P10", d = "_fSuccess", K = "_fFail", X = this;
...
$[f4R.d7X](YY.Page.baseMain.prototype, {
    ...
    contactInit: function() {
        var K4 = "submit", n4 = "", R4 = '<div class="netmask fixed loading"><div><i class="fa fa-check-circle"></i></div></div>', h4 = '"><p>微信扫一扫</p></div></div>', U = '<div class="fixed" id="fixed_mp"><div class="fixed-container"><img src="', u4 = "#mpbtn", A = $(u4);
        if (A.length) {
        ...
        var d4 = $(R4);
        $(n4)[K4](function(V) {
            var D = ".inputtxt.submit", Z = "json", G = "action", I = "post", P = "内容不能为空", W = "textarea[name='content']", N = "电话不能为空", k = "input[name='tel']", j = "tel", C = "邮箱格式不正确", m = "邮箱不能为空", e = "input[name='email']", F = "email", v = "姓名不能为空", Y = "val", J = "input[name='name']", i = this;
            V = {
                name: f4R.w9U,
                email: f4R.w9U,
                tel: f4R.w9U,
